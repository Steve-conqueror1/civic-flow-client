...
argument-hint: Short feature description (e.g., "add user profile page")
...
- A human friendly feature title in kebab-case (e.g. new-user-form)
- A safe git branch name not already taken (e.g. claude/feature/new-user-form)
